...
import BestSellingPackages from "../components/destination_details/BestSellingPackages";
...
//             <Chip
//               icon={<LocationOnIcon />}
//               label={`${destination.city ? `${destination.city}, ` : ""}${
...
//                 label={`${destination.packages?.length} packages`}
