...
function FeaturedPackages() {
  ...
  const featuredPackages = useMemo(() => {
    const featured = packages.filter(
      (travelPackage) => travelPackage.isFeatured
    );
    ...
    <section className="bg-slate-50 px-6 py-20 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          ...
          description="Explore active packages managed from the admin panel, shown here as premium homepage recommendations."
        />
        ...
        {!isLoading && !errorMessage && featuredPackages.length > 0 ? (
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
