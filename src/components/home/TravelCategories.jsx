...
const fallbackCategories = [
    {
        ...
        description: "Explore India with family trips, weekend escapes, pilgrimages, beaches, mountains, and cultural circuits.",
    ...
    },
    {
        ...
        description: "Plan curated international vacations with visa guidance, premium stays, guided tours, and smooth support.",
...
export const internationalDestinations = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?auto=format&fit=crop&w=900&q=85",
    },
    {
        name: "SINGAPORE",
...
function TravelCategories() {
    ...
    /* =======================================================
       FIND API CATEGORIES
    ======================================================= */
    const domesticCategory = categories.find((category) => category.categoryType === "domestic");
    const internationalCategory = categories.find((category) => category.categoryType === "international");
    /* =======================================================
       DOMESTIC CAROUSEL
       NO LOOPING
    ======================================================= */
    const showNextDomestic = () => {
        setDomesticIndex((previousIndex) => Math.min(previousIndex + 1, domesticDestinations.length - 1));
    };
    ...
    const showNextInternational = () => {
        setInternationalIndex((previousIndex) => Math.min(previousIndex + 1, internationalDestinations.length - 1));
    };
    ...
    /* =======================================================
       RENDER
    ======================================================= */
    return (<section className="bg-white px-6 py-16 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        {isLoading ? (<div className="space-y-16">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-5 lg:grid-cols-5">
                {Array.from({ length: 5 }).map((_, index) => (<Skeleton key={index} variant="rounded" height={300}/>))}
              </div>
            </div>
        ...
        {!isLoading && errorMessage ? (<Alert severity="warning" className="mb-10">
            {errorMessage}
          </Alert>) : null}
        ...
        {!isLoading && (<div className="space-y-16">
            ...
            <section>
              ...
              <div className="mb-7 flex items-center justify-between gap-4">
                ...
                <Link to={domesticCategory?.ctaUrl ||
                "/destinations"} className="group inline-flex items-center gap-3">
            ...
            /> */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* Previous */}
                  <button type="button" onClick={showPreviousDomestic} disabled={domesticIndex === 0} aria-label="Previous domestic destinations" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#eadfce] bg-[#fffaf4] text-slate-600 transition-all duration-300 hover:border-[#d8c4a9] hover:bg-[#f8f0e5] hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35">
                    <ArrowBackIosNewIcon sx={{ fontSize: 15 }}/>
                  </button>

                  {/* Next */}
                  <button type="button" onClick={showNextDomestic} disabled={domesticIndex ===
                domesticDestinations.length - 1} aria-label="Next domestic destinations" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#eadfce] bg-[#fffaf4] text-slate-700 transition-all duration-300 hover:border-[#d8c4a9] hover:bg-[#f8f0e5] hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35">
              ...
              <div className="overflow-hidden">
                ...
                <div className="flex gap-5 transition-transform duration-500 ease-out" style={{
                transform: `translateX(-${domesticIndex * 20.8}%)`,
            }}>

                  {domesticDestinations.map((destination) => (<div key={destination.name} className="group relative min-w-[75%] overflow-hidden rounded-2xl sm:min-w-[45%] lg:min-w-[19%]">

                        <div className="relative h-[300px] overflow-hidden rounded-2xl">

                          {/* Image */}
                          <img src={destination.image} alt={destination.name} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"/>
                          ...
                          <div className="absolute bottom-0 left-0 w-full p-5 text-white">
                            ...
                            <p className="mb-1 text-[10px] font-bold tracking-wide text-white/90 sm:text-[11px]">
                              {destination.tagline}
                            </p>

                            <h3 className="font-serif text-2xl font-medium tracking-wide sm:text-3xl">
                              {destination.name}
                            </h3>
            ...
            <section>
              ...
              <div className="mb-7 flex items-center justify-between gap-4">
                ...
                {/* Heading itself is CTA */}
                <Link to={internationalCategory?.ctaUrl ||
                "/packages"} className="group inline-flex items-center gap-3">
                  <h2 className="text-2xl font-extrabold tracking-tight text-slate-900 transition-colors duration-300  sm:text-3xl">
                    INTERNATIONAL DESTINATIONS
                  </h2>
            ...
            /> */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* Previous */}
                  <button type="button" onClick={showPreviousInternational} disabled={internationalIndex === 0} aria-label="Previous international destinations" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#eadfce] bg-[#fffaf4] text-slate-600 transition-all duration-300 hover:border-[#d8c4a9] hover:bg-[#f8f0e5] hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35">
                    <ArrowBackIosNewIcon sx={{ fontSize: 15 }}/>
                  </button>

                  {/* Next */}
                  <button type="button" onClick={showNextInternational} disabled={internationalIndex ===
                internationalDestinations.length - 1} aria-label="Next international destinations" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#eadfce] bg-[#fffaf4] text-slate-700 transition-all duration-300 hover:border-[#d8c4a9] hover:bg-[#f8f0e5] hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35">
                    <ArrowForwardIosIcon sx={{ fontSize: 15 }}/>
                  </button>
              ...
              <div className="overflow-hidden">
                ...
                transform: `translateX(-${internationalIndex * 20.8}%)`,
                  ...
                  {internationalDestinations.map((destination) => (<div key={destination.name} className="group relative min-w-[75%] overflow-hidden rounded-2xl sm:min-w-[45%] lg:min-w-[19%]">
