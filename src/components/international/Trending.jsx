...
export default function Trending() {
  const [trendingDestinations, setTrendingDestinations] =
    useState([]);
  ...
  // -------------------------------------------------------
  // FETCH TRENDING INTERNATIONAL DESTINATIONS
  // -------------------------------------------------------
    ...
    const fetchTrendingDestinations = async () => {
      try {
        ...
        const filtered = res.data.data.filter(
          (destination) =>
            Number(destination.categoryId) === 2
        );

        setTrendingDestinations(filtered);
      } catch (error) {
        console.error(
          "Failed to fetch trending international destinations:",
          error
        );
