...
function BlogCard({ blog }) {
  ...
  return (
    <Card
      className="group overflow-hidden border border-slate-100 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
      sx={{ borderRadius: 4 }}
    >
      ...
      <CardContent sx={{ p: 3 }}>
        ...
        <Typography
          variant="h3"
          className="mt-4 line-clamp-2 text-2xl font-black text-slate-950"
        >
          {blog.title}
        </Typography>
